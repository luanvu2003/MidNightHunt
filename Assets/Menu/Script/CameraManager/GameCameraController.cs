...
public class GameCameraController : MonoBehaviour
{
    ...
    public Vector3 tpsOffset = new Vector3(0.5f, 1.5f, -3f); // Đứng lệch vai (Over-the-shoulder)
